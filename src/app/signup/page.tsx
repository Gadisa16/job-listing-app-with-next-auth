    ...
    <div className='mt-10 w-5/12 bg-slate-40'>
        ...
        <div className='flex w-full flex-col space-y-6 items-center'>
            ...
            <Link className='w-full flex justify-center' href="/api/auth/signin">
                <div onClick={()=> {signIn("google", {callbackUrl:"/"})}} className='flex w-9/12 justify-center space-x-3 border border-[#CCCCF5] py-2'>
        ...
        <div className='w-full flex justify-center'>
            ...
            <form onSubmit={(e) => e.preventDefault()} className='mb-3 mt-5 w-3/4 flex flex-col space-y-5' action="">
                ...
                <div className='flex space-y-2 flex-col'>
                    ...
                    <input className='bg-white border p-2' type="password" placeholder='password'
                        {...register("confirmPassword", {required: "You have to confirm your password"})
                        }
                    />
                </div>
